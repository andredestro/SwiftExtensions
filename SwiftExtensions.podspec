...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/André Felipe Destro/SwiftExtensions'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'André Felipe Destro' => 'afdestro@gmail.com' }
  s.source           = { :git => 'https://github.com/André Felipe Destro/SwiftExtensions.git', :tag => s.version.to_s }
